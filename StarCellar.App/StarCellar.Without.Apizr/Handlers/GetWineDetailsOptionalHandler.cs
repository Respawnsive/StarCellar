...
{
    public record GetWineDetailsOptionalQuery(Guid Id, Priority Priority) : IRequest<Option<Wine, string>>;

    public class GetWineDetailsOptionalHandler : IRequestHandler<GetWineDetailsOptionalQuery, Option<Wine, string>>
    {
        ...
        public GetWineDetailsOptionalHandler(IMapper mapper, 
            IMemoryCache cache, 
        ...
        /// <inheritdoc />
        public async Task<Option<Wine, string>> Handle(GetWineDetailsOptionalQuery request, CancellationToken cancellationToken)
        {
            // FetchOrGet behavior
            Wine wineDetails;
            ...
            return wineDetails.SomeNotNull("Failed to get wine!");
        }
    }
}
